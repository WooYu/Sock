...
void main() {
  ...
  test('loads approved structured note rules into the deterministic RuleBook', () async {
    final repository = MemoryKnowledgeRepository(
      sources: const [
        KnowledgeSource(
          id: 'source-2',
  ...
  test('approved note without measurable conditions remains non-triggerable', () async {
    final repository = MemoryKnowledgeRepository(
      sources: const [
        KnowledgeSource(
          id: 'source-3',

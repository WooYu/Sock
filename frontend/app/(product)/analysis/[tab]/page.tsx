...
export default async function AnalysisRoute({ params, searchParams }: { params: Promise<{ tab: string }>; searchParams: Promise<{ symbol?: string }> }) {
  ...
  return <StockWorkspaceProvider initialSymbol={symbol}><ProductShell section="analysis"><AnalysisPage tab={tab as AnalysisTab} /></ProductShell></StockWorkspaceProvider>
}

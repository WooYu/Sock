...
export function PatternsPanel({ analysis }: { analysis?: StockAnalysis | null }) {
  if (!analysis) return <p className="sc-analysis-empty rounded-2xl border border-dashed border-[var(--sc-border)] p-6 text-sm text-[var(--sc-muted)]">盈利模式等待行情快照。</p>
